            ...
            <div className="w-full lg:w-72 lg:order-0 order-first">
              ...
              <div className="bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-2xl p-6 text-white shadow-lg">
                ...
                <div className="space-y-3">
                  <button className="w-full bg-white text-cyan-600 font-semibold py-2 px-4 rounded-lg flex items-center justify-center gap-2 hover:bg-teal-200 hover:text-gray transition-colors text-sm">
